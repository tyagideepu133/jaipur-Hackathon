...
class CarStatus(models.Model):
    ...
    car_number = models.OneToOneField(Car, primary_key=True, on_delete=models.DO_NOTHING)
    car_type = models.CharField(max_length=20, default="normal")
    car_driver_id = models.ForeignKey(Driver, on_delete=models.DO_NOTHING)
...
class CarJourney(models.Model):
    ...
    jcar_number = models.ForeignKey(Car, on_delete=models.DO_NOTHING)
    jdriver_id = models.ForeignKey(Driver, on_delete=models.DO_NOTHING)
...
class CarEmergency(models.Model):
    ...
    ec_car_number = models.ForeignKey(Car, related_name='+', on_delete=models.DO_NOTHING)
    ec_driver_id = models.ForeignKey(Driver, related_name='+', on_delete=models.DO_NOTHING)
    vc_car_number = models.ForeignKey(Car, related_name='+', on_delete=models.DO_NOTHING)
    vc_driver_id = models.ForeignKey(Driver, related_name='+', on_delete=models.DO_NOTHING)
